...
api.add_namespace(settings_ns, path='/setting')  # Routes for setting operations
...
api.add_namespace(invoice_items_ns, path='/invoice_item')  # Routes for invoice_item operations